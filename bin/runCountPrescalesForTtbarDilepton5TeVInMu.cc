#include "UserCode/diall/countPrescalesForTtbarDilepton5TeVInMu.C"
...
int main(int argc, char* argv[])
{
  ...
  countPrescalesForTtbarDilepton5TeVInMu(urls,outname.c_str(),maxEvts,firstFile,lastFile,firstEvent,isData);
