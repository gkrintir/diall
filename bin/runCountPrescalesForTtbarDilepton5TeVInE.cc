#include "UserCode/diall/countPrescalesForTtbarDilepton5TeVInE.C"
...
int main(int argc, char* argv[])
{
  ...
  countPrescalesForTtbarDilepton5TeVInE(urls,outname.c_str(),maxEvts,firstFile,lastFile,firstEvent,isData);
