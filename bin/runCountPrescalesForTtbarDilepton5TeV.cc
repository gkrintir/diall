#include "UserCode/diall/countPrescalesForTtbarDilepton5TeV.C"
...
int main(int argc, char* argv[])
{
  ...
  countPrescalesForTtbarDilepton5TeV(urls,outname.c_str(),maxEvts,firstFile,lastFile,firstEvent,isData);
