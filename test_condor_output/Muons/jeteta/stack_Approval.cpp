...
void stack_Approval(const TString& variable, const TString& dilepton, const Int_t nBinsX, const Float_t binXLow, const Float_t binXUp, const TString& iso) {
   ...
   const TString folder = "/home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/test_condor_output/Muons/jeteta";
   ...
   for (int i=1; i<8; i++){ //984, 1224
     //if (i==265 || i==360 || i==373 || i==375 || i==377 | i==472 || i==485 || i==810 || i==866 || i==1196 || i==1197 || i==460 || i==505)  continue;
     ...
     //addToStack(Form("%s/%s_%d.root", folder.Data(),"AnaResults", i), dilepton.Data(), "Single_op", true, kBlack, 21, kBlack, *hs_data );
   }
...
void addToStack(const TString& filename, const TString& variable,  const TString& legentry, Bool_t sumw2, const EColor& fillcolor, Int_t MarkerStyle,  const EColor& MarkerColor, THStack& hs) {
   ...
   TList *anaPFvsCaloJet = dynamic_cast<TList*>(f->Get(variable.Data()));
   TH1F * pt_muon = dynamic_cast<TH1F*>(anaPFvsCaloJet->FindObject("fNEvents"));
