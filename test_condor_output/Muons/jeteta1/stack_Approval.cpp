...
void stack_Approval(const TString& variable, const TString& dilepton, const Int_t nBinsX, const Float_t binXLow, const Float_t binXUp, const TString& iso) {
   ...
   const TString folder = "/home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/test_condor_output/Muons/jeteta1";
   ...
   for (int i=984; i<1224; i++){ //984, 1224
     if (i==101 || i==1031 || i==105 || i==106 || i==107 || i==109 || i==110 || i==47 || i==48 || i==834 || i==839 || i==884 || i==885 || i==900 || i==905 || i==906 || i==950 || i==970 || i==989 || i==1080 || i==1085 || i==1100 || i==1111 || i==1112 || i==1115) continue;
...
void addToStack(const TString& filename, const TString& variable, const TString& dilepton, const TString& legentry, Bool_t sumw2, Int_t nbins, Float_t binXLow, Float_t binXUp,
   ...
   TBranch * bla; 
   std::vector<double> *px=0; std::vector<double> *dilepmass=0; std::vector<double> *eleeta=0;
   //int px[2000000];
