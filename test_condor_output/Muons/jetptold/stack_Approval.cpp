...
void stack_Approval(const TString& variable, const TString& dilepton, const Int_t nBinsX, const Float_t binXLow, const Float_t binXUp, const TString& iso) {
   ...
   const TString folder = "/home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/test_condor_output/Muons/jetptold";
   ...
   for (int i=984; i<1224; i++){ //984, 1224
     //if (i==1000 || i==1004 || i==1005 || i==1006 || i==1010 || i==395 || i==499 || i==501 || i==505 || i==508 || i==563 || i==564 || i==571 || i==593 || i==659 || i==970) continue;
