...
void stack_Approval(const TString& variable, const TString& dilepton, const Int_t nBinsX, const Float_t binXLow, const Float_t binXUp, const TString& iso) {
   ...
   const TString folder = "/home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/test_condor_output/Photons/backup";
   ...
   */
   ...
   hs_data->GetStack()->Last()->SaveAs(Form("%sendcap_%s.root", variable.Data(), dilepton.Data()));
