...
void stack_Approval(const TString& variable, const TString& dilepton, const Int_t nBinsX, const Float_t binXLow, const Float_t binXUp, const TString& iso) {
   ...
   const TString folder = "/home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/test_condor_output/WJets/test1";
   ...
   for (int i=1; i<4; i++){ //118
     //if (i==104 || i==48 || i==43 || i==106 || i==6 || i==60)continue;
     ...
     //addToStack(Form("%s/%s_%d.root", folder.Data(),"test", i), "fNEvents","Single_top", true, kBlack, 21, kBlack, *hs_data );
   }
