...
void countPrescalesForTtbarDilepton5TeVInMu(std::vector<std::string> urls, const char *outname = "AnaResults.root", Long64_t nentries = 20, Int_t firstF = -1, Int_t lastF = -1, Int_t firstEvent = 0, int isData = 1) {
  ...
  Int_t presc_HLTval[2];
  std::vector<TString> presc_HLTname = { "HLT_HIL3Mu15_v1_Prescl","HLT_HIL3Mu20_v1_Prescl"};
  Int_t presc_L1val[2];

  std::vector<TString> presc_L1name =  {"L1_SingleMu12_BptxAND_Prescl", "L1_SingleMu16_BptxAND_Prescl"};
