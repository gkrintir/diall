...
export OUTDIR=/nfs/scratch/fynu/gkrintiras/Trigger/Muons
cd /home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/
eval `scram r -sh`
cd -
cp /home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/scripts/Muons/ExampleAnalysisParameters_cfg.py .
...
runCountPrescalesForTtbarDilepton5TeVInMu ${args[0]} ${args[1]} ${args[2]} ${args[3]}
