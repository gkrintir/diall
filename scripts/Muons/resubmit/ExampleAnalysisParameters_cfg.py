...
FSimfile = open('/home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/SingleMuHighPt_Run2015E-PromptReco-v1_v2.data', 'r')
...
config = cms.PSet(
    ...
    triggerPath = cms.string('HLT_HIL3Mu15_v1'),
