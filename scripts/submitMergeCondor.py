...
for n in xrange(1,opt.jobs+1):
    ...
    scriptFile.write('arguments = /home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/SingleMuHighPt_Run2015E-PromptReco-v1_v1.data %d %d %d HiForest_%d.root\n' % ( 1, (n-1)*(opt.files-1), n*(opt.files-1), n ))
