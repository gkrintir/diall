...
FSimfile = open('/home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/WJetsToLNu_TuneCUETP8M1_5020GeV-amcatnloFXFX-pythia8.txt', 'r')
...
config = cms.PSet(
    ...
    triggerPath = cms.string('HLT_HIDoublePhoton15_Eta2p5_Mass50_1000_R9SigmaHECutForPPRef_v1'),
