...
FSimfile = open('/home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/TT_TuneCUETP8M1_5020GeV-powheg-pythia8.txt')
...
config = cms.PSet(
    ...
    #input =
        #cms.vstring( 
        #'file:/nfs/scratch/fynu/gkrintiras/Ttbar/HiForest_0.root'
