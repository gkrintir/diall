...
FSimfile = open('/home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/HighPtLowerPhotons_Run2015E-PromptReco-v1_v2.data', 'r')
...
config = cms.PSet(
    ...
    triggerPath = cms.string('HLT_HISinglePhoton30_Eta3p1_v1'),
