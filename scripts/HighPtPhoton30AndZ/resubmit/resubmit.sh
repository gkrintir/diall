#!/bin/bash
 ...
 do
     ...
     echo 'arguments = /home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/scripts/Photons1/resubmit/ExampleAnalysisParameters_cfg.py 1' $num >>rediall_test.condor
