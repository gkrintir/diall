#!/bin/bash
 ...
 grep -lm 1 "exist" log/log*.error | sed -e s/[^0-9]//g > match.txt
 ...
 do
     ...
     echo 'arguments = /home/fynu/gkrintiras/CMSSW_7_5_7_patch2/src/UserCode/diall/scripts/HighPtPhoton30AndZ/ExampleAnalysisParameters_cfg.py 1' $num >>rediall_test.condor
